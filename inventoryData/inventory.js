 ...
 * @since:29-Nov-2019
 */
//importing an glossary.js file
let util = require("../inventoryData/glossary");
let fs = require("fs");
//readFileSync(): used to to read JSON file
let content = fs.readFileSync(
  "/home/admin1/Girijavascript/objectOrianted/inventoryData/inventory.json",
  "utf8"
);
console.log(content);
//JSON.Prase()// used to conver String to javascriptObject
...
for (let i = 0; i < leng; i++) {
  ...
  let company = new util(name, weight, price);
  let total2 = company.total();
  console.log(
    "Name : " + name + " , " + "Weight : " + weight + " , " + "price : " + price
  );
  console.log("Total price of rice is =" + total2);
}
console.log("====================================");
...
for (let i = 0; i < leng; i++) {
  ...
  let company = new util(name, weight, price);
  let total3 = company.total();
  console.log(
    "Name : " + name + " , " + "Weight : " + weight + " , " + "price : " + price
  );
  console.log("Total price of rice is =" + total3);
}
